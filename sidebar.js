...
async function updateSpaceSwitcher() {
    ...
    spaces.forEach(space => {
        ...
        button.setAttribute('title', `Switch to space ${space.name}`);
    ...
    spaceFolders.forEach(spaceFolder => {
        if (spaces.find(space => space.name == spaceFolder.title)) {
            ...
            button.setAttribute('aria-label', `Switch to space ${spaceFolder.title}`);
            button.setAttribute('title', `Switch to space ${spaceFolder.title}`);
            button.addEventListener('click', async () => {
